...
%英文图表
\captionsetup[figure]{name={Fig.},labelsep=period, belowskip=0bp,aboveskip=0bp, font={capFont}}
\captionsetup[table]{name={Tab.},labelsep=period, belowskip=0bp,aboveskip=0bp, font={capFont}}
%中文图标
...
\captionsetup[subfloat]{captionskip=6bp,nearskip=0bp,farskip=0bp,topadjust=0bp,
  justification=centering,labelformat=brace,labelsep=space}%要使分图题和图题一样字号，选项加上 font={capFont}  %删除 ,subrefformat=subparens,listofformat=parens % 修改引用
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%毕业论文版
...
\title{\vspace{-1.5cm} \bf\xiaoerhao INDI-based Angular Velocity Control for a Ducted Fan UAV with Redundant Actuators}
\author{\bf\sihao Name}
\date{}
...
\fancyhead[LE]{}
\fancyhead[LO]{}
\fancyhead[CO]{\wuhao{South China University of Technology}}
\fancyhead[CE]{\wuhao{INDI-based Angular Velocity Control for a Ducted Fan UAV with Redundant Actuators}}% 
...
%	\addtolength{\parskip}{0pt}
	...
	\printbibliography[title={References}]	% 参考文献著录 
